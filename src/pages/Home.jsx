                ...
                <div className="py-24 text-center relative overflow-hidden">
                    ...
                    <Container>
                        <div className="max-w-4xl mx-auto space-y-10 relative z-10">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-xs font-bold text-primary uppercase tracking-widest animate-in fade-in slide-in-from-top-4 duration-700">
                        ...
                        <div className="space-y-12">
                            <div className="flex items-end justify-between border-b border-white/5 pb-8">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-muted-foreground/60 text-sm font-medium">LATEST UPDATES FROM OUR CREATORS</p>
                                </div>
